...
router.get('/count', function (req, res, next) { 
    const count=Exoplanet.countPerYear(req.query.howManyPerYear).count;
    const year = req.query.howManyPerYear;
    
    res.render('exoplanets/index.hbs', {exoplanetsTable: Exoplanet.list(), count, year});
});

router.get('/tri', function (req, res, next) { 
    const triPar = req.query.triPar;
    console.log(triPar);
    const SortedTable = Exoplanet.sort(triPar);
    res.render('exoplanets/index.hbs',{exoplanetsTable:SortedTable} );
});
